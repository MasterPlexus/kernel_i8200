...
static unsigned long helandkb_pin_config[] __initdata = {
	GPIO000_GPIO_0 | MFP_LPM_INPUT | MFP_PULL_HIGH, /* NC */			/* KP_MKIN[0] */
...
#define GPIO019_LCD_ESD_DETECT		(GPIO019_GPIO_19 | MFP_LPM_INPUT)
	...
	GPIO014_3M_CAM_STBY |MFP_PULL_LOW | MFP_LPM_DRIVE_LOW,
	GPIO015_3M_CAM_RESET |MFP_PULL_LOW | MFP_LPM_DRIVE_LOW,
	GPIO016_GPIO_16 | MFP_LPM_INPUT | MFP_PULL_LOW, /* NC */
	GPIO017_GPIO_17 | MFP_LPM_INPUT | MFP_PULL_LOW, /* NC */
	GPIO018_LCD_RESET,
	GPIO019_LCD_ESD_DETECT,
	GPIO020_GPIO_20 | MFP_LPM_INPUT| MFP_PULL_LOW,
...
#define GPIO053_AP_AGPS_RESET	(GPIO053_GPIO_53)
	...
	GPIO067_CAM_DATA7 | MFP_LPM_DRIVE_LOW,
	GPIO068_CAM_DATA6 | MFP_LPM_DRIVE_LOW,
	GPIO069_CAM_DATA5 | MFP_LPM_DRIVE_LOW,
	GPIO070_CAM_DATA4 | MFP_LPM_DRIVE_LOW,
	GPIO071_CAM_DATA3 | MFP_LPM_DRIVE_LOW,
	GPIO072_CAM_DATA2 | MFP_LPM_DRIVE_LOW,
	GPIO073_CAM_DATA1 | MFP_LPM_DRIVE_LOW,
	GPIO074_CAM_DATA0 | MFP_LPM_DRIVE_LOW,
	GPIO075_CAM_HSYNC | MFP_LPM_DRIVE_LOW,
	GPIO076_CAM_VSYNC | MFP_LPM_DRIVE_LOW,
	GPIO077_CAM_MCLK | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW, /* CAM_MCLK */
	GPIO078_CAM_PCLK,
	GPIO079_3M_CAM_SCL | MFP_LPM_FLOAT,
	GPIO080_3M_CAM_SDA | MFP_LPM_FLOAT,

	GPIO081_1M3_CAM_RSTN | MFP_PULL_LOW |MFP_LPM_DRIVE_LOW,
	GPIO082_1M3_CAM_STBY | MFP_PULL_LOW |MFP_LPM_DRIVE_LOW, 
...
#define GPIO_VCM_PWDN		ND_CS1N3_GPIO_102
	GPIO_GPS_TIMER_SYNC,
	SM_ADV_GPIO_0 | MFP_PULL_HIGH | MFP_LPM_FLOAT, //GPIO_0
#if !defined(CONFIG_KEYBOARD_GPIO)
	GPIO_LCD_RESET_N | MFP_PULL_HIGH | MFP_LPM_FLOAT,  //GPIO_1
	SM_ADVMUX_GPIO_2 | MFP_PULL_HIGH | MFP_LPM_FLOAT,  //GPIO_2
#endif
...
static struct regulator_consumer_supply regulator_supplies[] = {
	...
	[PM822_ID_LDO3]  = REGULATOR_SUPPLY("v_ldo3", NULL),
	[PM822_ID_LDO4]  = REGULATOR_SUPPLY("v_cam_avdd",NULL),
	...
	[PM822_ID_LDO9]  = REGULATOR_SUPPLY("v_cam_io", NULL),
	[PM822_ID_LDO10] = REGULATOR_SUPPLY("v_wib_3v3", NULL),
	[PM822_ID_LDO11] = REGULATOR_SUPPLY("v_sensor", NULL),
	[PM822_ID_LDO12] = REGULATOR_SUPPLY("v_cam_core", NULL),
...
static struct regulator_init_data pm822_regulator_data[] = {
	...
	[PM822_ID_BUCK5] = REG_INIT(BUCK5,  600000, 3300000, 0, 0),
...
static struct sec_jack_zone sec_jack_zones[] = {
	...
	{
		/* 350 < adc <= 1050, unstable zone, default to 4pole if it
	...
	{
		/* 1050 < adc <= 1399, default to 4 pole if it stays */
...
static void i2c_pxa_bus_reset(int i2c_adap_id)
{
	...
	unsigned long i2c0_mfps[] = {
		GPIO079_3M_CAM_SCL,		/* SCL */
		GPIO080_3M_CAM_SDA,		/* SDA */
	};
	unsigned long i2c1_mfps[] = {
		GPIO087_GPIO_87,		/* SCL */
		GPIO088_GPIO_88,		/* SDA */
	};
	unsigned long i2c2_mfps[] = {
		GPIO029_1M3_CAM_SCL,		/* SCL */
		GPIO030_1M3_CAM_SDA,		/* SDA */
	};
	if (i2c_adap_id == 0) {
		scl = MFP_PIN_GPIO79;
		sda = MFP_PIN_GPIO80;
	...
	if (i2c_adap_id == 4)
		mfp_config(ARRAY_AND_SIZE(i2c2_mfps));
	...
	if (i2c_adap_id == 4) {
		mfp_write(MFP_PIN_GPIO29, mfp_pin[0]);
		mfp_write(MFP_PIN_GPIO30, mfp_pin[1]);
	}
	gpio_free(sda);
out_sda0:
	gpio_free(scl);
...
#elif defined(CONFIG_MFD_88PM822)
	.adc_channel	= PM822_GPADC1_MEAS1, /* GoldenVE TEMP_RF */
#endif
...
static void helan_dkb_poweroff(void)
{
	...
	pm822_extern_write(PM822_BASE_PAGE, PMIC_GENERAL_USE_REGISTER, PMIC_GENERAL_USE_BOOT_BY_NONE);
