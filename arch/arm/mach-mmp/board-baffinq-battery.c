/* arch/arm/mach-mmp/board-baffinq-battery.c
 *
...
static sec_charging_current_t charging_current_table[] = {
	...
	{750,	750,	200,	1800},     /* POWER_SUPPLY_TYPE_MAINS */
	{550,	500,	200,	1800},     /* POWER_SUPPLY_TYPE_USB */
	{550,	500,	200,	1800},     /* POWER_SUPPLY_TYPE_USB_DCP */
	{550,	500,	200,	1800},     /* POWER_SUPPLY_TYPE_USB_CDP */
	{550,	500,	200,	1800},     /* POWER_SUPPLY_TYPE_USB_ACA */
	{550,	500,	200,	1800},     /* POWER_SUPPLY_TYPE_MISC */
	{0,		0,		0,		0},     /* POWER_SUPPLY_TYPE_CARDOCK */
	{550,	500,	200,	1800},     /* POWER_SUPPLY_TYPE_WPC */
	{750,	750,	200,	1800},     /* POWER_SUPPLY_TYPE_UARTOFF */
};
...
void sec_charger_cb(u8 cable_type)
{
	...
	case CABLE_TYPE3_DESKDOCK_VB_MUIC:
		pr_info("%s: DESKDOCK+VBUS Attached\n", __func__);
		current_cable_type = POWER_SUPPLY_TYPE_USB;
		break;
...
void __init pxa1088_baffinq_battery_init(void)
{
	pr_info("%s: baffinq charger init\n", __func__);
