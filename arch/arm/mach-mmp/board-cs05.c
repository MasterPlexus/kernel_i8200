...
static unsigned long helandkb_pin_config[] __initdata = {
	...
	GPIO005_GPIO_5 | MFP_LPM_DRIVE_LOW, /* MPR_I2C0_SCL */
	GPIO006_GPIO_6 | MFP_LPM_DRIVE_LOW, /* MPR_I2C0_SDL */
	GPIO007_GPIO_7 | MFP_PULL_LOW |MFP_LPM_DRIVE_LOW ,
...
#define GPIO017_CHG_SDA	(GPIO017_GPIO_17 | MFP_PULL_HIGH )
	...
	/*GPIO030_UART3_RTS,*/
	GPIO030_GPIO_30 |MFP_LPM_DRIVE_LOW,
...
#define GPIO032_HW_REV_MOD_2            (GPIO032_GPIO_32 | MFP_PULL_FLOAT)
	...
	GPIO033_GPIO_33 | MFP_LPM_INPUT | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW,
	GPIO034_GPIO_34 | MFP_LPM_INPUT | MFP_PULL_HIGH | MFP_LPM_DRIVE_LOW, /*LOW -> TO VX*/
...
#define GPIO094_GPIO_TSP_INT		(GPIO094_GPIO_94 | MFP_PULL_HIGH | MFP_LPM_PULL_LOW)
	...
	GPIO095_GPIO_95 | MFP_PULL_HIGH | MFP_LPM_DRIVE_LOW,
...
#define GPIO125_VX6B3E_RESET	(GPIO125_VCXO_REQ | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW)
...
#define GPIO_VCM_PWDN		ND_CS1N3_GPIO_102
	...
	GPIO127_GPIO_127 | MFP_PULL_HIGH | MFP_LPM_DRIVE_LOW,
...
static struct regulator_consumer_supply regulator_supplies[] = {
	...
	[PM822_ID_LDO9]  = REGULATOR_SUPPLY("v_lcd_3v0", NULL),
	[PM822_ID_LDO10] = REGULATOR_SUPPLY("v_wib_3v3", NULL),
	[PM822_ID_LDO11] = REGULATOR_SUPPLY("v_proxy_3v", NULL),
...
static struct regulator_init_data pm822_regulator_data[] = {
	...
	[PM822_ID_LDO1]  = REG_INIT(LDO1,  2900000, 2900000, 0, 0),
...
static struct regulator_consumer_supply regulator_supplies[] = {
	...
	[PM800_ID_LDO8]  = REGULATOR_SUPPLY("v_lcd_3v0", NULL),
...
__weak struct regulator_consumer_supply d2199_ldo12_supplies[] = {
	REGULATOR_SUPPLY("v_lcd_3v0", NULL),	// V_LCD_3.0V
};
...
{
#if defined(CONFIG_CS05_BD_00)
	static struct regulator *proxLed;
#elif defined(CONFIG_CS05_BD_02)
	static int proxy_led_en;
#endif
	...
	if(blFirst)
	{
		...
		proxy_led_en = mfp_to_gpio(GPIO091_GPIO_91);
		gpio_request(proxy_led_en,"PROXY_LED_EN");
#endif
	...
	if(on){
		...
		regulator_enable(proxLed);
#elif defined(CONFIG_CS05_BD_02)
		gpio_direction_output(proxy_led_en,1);
#endif
		msleep(2);
		...
		regulator_disable(proxLed);
#elif defined(CONFIG_CS05_BD_02)
		gpio_direction_output(proxy_led_en,0);
#endif
		blStatus = 0;
	}
...
static void __init helandkb_init_mmc(void)
{
	...
	add_sd8x_rfkill_device(WIB_PDn, NULL,
...
#if defined(CONFIG_SENSORS_BMA2X2) || defined(CONFIG_SENSORS_BMM050) || defined(CONFIG_SENSORS_GP2A002S) || defined(CONFIG_SENSORS_GP2A030) || defined(CONFIG_SENSORS_BMA254)
